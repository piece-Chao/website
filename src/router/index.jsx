...
const BabelBasic = lazy (() => import('@/screen/Tattle/Babel_basic'));
const Precision = lazy (() => import('@/screen/JavaScript/Basics/Precision'));
...
const ArraySort = lazy (() => import('@/screen/JavaScript/Array/Array_sort'));
const NewTheory = lazy (() => import('@/screen/JavaScript/Basics/NewTheory'));
            ...
            <ScrollToTop>
                <Suspense fallback={<ActivityIndicator toast text="Loading..." />}>
                    <Switch>
                        ...
                        <Route path='/Array_sort' component={props => <ArraySort {...props} />} />
                        <Route path='/New_theory' component={props => <NewTheory {...props} />} />
                    </Switch>
                </Suspense>
            </ScrollToTop>
        )
